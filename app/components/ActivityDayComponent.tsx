...
import style from '../features/impostor/ImpostorList.module.css';
...
const ActivityDayComponent: React.FC<ActivityDayProps> = ({ date, activities }) => {
    // const { activities } = useSelector((state: RootState) => state.impostor);
